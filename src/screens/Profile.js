...
const PLACEHOLDER_AVATAR =
  "https://firebasestorage.googleapis.com/v0/b/chillmate-241a3.appspot.com/o/general%2Favatar.jpg?alt=media&token=4dcdfa81-fea1-4106-9306-26d67f55d62c";
let uid;
...
class ProfileScreen extends Component {
  ...
  loadWhatsapp = () => {
    ...
    Linking.openURL(
      "whatsapp://send?text=Hey, checkout Tagmate. I use it know what's happening on campus - https://tagmateapp.com"
    );
  };
  ...
  dmAllowToggle = () => {
    firebase
      .database()
      .ref(`/users/${uid}`)
      .update({ dmAllow: !this.state.dmAllow });
    ...
    firebase
      ...
      .once("value", snapshot => {
        ...
        if (snapshot.val() != null) {
          ...
          firebase
            .storage()
            .ref(`${this.state.networkId}/imgs`)
            .child(profileImageId + ".jpeg")
            .delete();
          firebase
            .storage()
            .ref(`${this.state.networkId}/imgs`)
            .child("thumb_" + profileImageId + ".jpeg")
            .delete();
        ...
        firebase
          ...
          .on(
            ...
            function(snapshot) {
              if (this._isMounted)
                this.setState({
                  photoURL: snapshot.val() || PLACEHOLDER_AVATAR,
                  loading: false
                });
            }.bind(this)
          );
        ...
        <ScrollView>
          <View style={styles.backgroundContainer}>
            <Card>
              ...
              >
                <Text style={adourStyle.titleTextCenter}>
              ...
              >
                ...
                <Text style={adourStyle.reputationText}>
                  {" "}
                  {this.state.coins}
                </Text>
              </View>
